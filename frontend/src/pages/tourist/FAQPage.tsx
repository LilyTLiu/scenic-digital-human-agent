...
const faqs = [
  ...
  {
    q: '数字人需要什么浏览器支持？',
    a: '真人数字人基于WebRTC实时视频流，支持Chrome、Edge、Firefox等现代浏览器。建议使用最新版本浏览器，需要摄像头/麦克风权限。移动端浏览器同样支持。',
  },
  {
    q: '如何进行景区导览？',
...
const features = [
  ...
  },
  {
    icon: '🤖',
    title: '3D数字人',
    desc: '基于QuickTalk GPU实时口型模型，RTX 4060本地推理，延迟低于1秒，让AI导游栩栩如生。',
  },
  {
    icon: '🗺️',
    title: '智能导览',
